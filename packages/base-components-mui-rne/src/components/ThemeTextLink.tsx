...
export const ThemeTextLink: FunctionComponent<ThemeTextLinkProps & ThemeTextProps> = ({toPath, children, textStyle}) => {
    return (
      <Link to={toPath}><ThemeText textStyle={textStyle}>{children}</ThemeText></Link>
    )
  }
